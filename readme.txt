ThreadLocal:
ThreadLocal Implementation in cpp as it is implememted in java

Condiitonal_Synchronisation:
...
use fork and join frame work to combine theri result into a complete gray scale image